...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <form action="{{ route('admin.banners.update', $banner) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold">Ganti Gambar Banner (Kosongkan jika tidak diganti)</label>
                    <input type="file" name="image" class="form-control" accept="image/*">
                    <div class="mt-2">
                        <img src="{{ asset('storage/' . $banner->image) }}" class="rounded border" width="200" alt="Banner Lama">
                    </div>
                </div>
            ...
            <button class="btn btn-warning px-4"><i class="bi bi-pencil-square me-1"></i> Update Banner</button>
        </form>
    </div>
</div>
@endsection